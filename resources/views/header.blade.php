                           ...
                           <!-- 
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href='https://codecanyon.kreativdev.com/plusagency/car'>Ø¹Ø±Ø¨Ù</a>
                                </div>
                            </div> -->
               ...
               <div class="site_menu">
                   <div class="row align-items-center">
                       <div class="col-lg-2 col-sm-12">
                           <div class="brand">
                               <a href="./"><img data-src="{{ asset('assets/front/img/logostarlabs2.png') }}" class=" img-fluid lazy" alt=""></a>
                           </div>
                       </div>
                       <div class="col-lg-8">
                                       ...
                                       <li class="menu-item-has-children">
                                           ...
                                           <ul class="sub-menu">
                                               ...
                                               <!-- <li class="submenus">
                                                ...
                                                <li>
                                                   <a href="{{route('pack')}}" target="_self">Développment web & mobile</a>
                                               </li>
                                               <li>
                                                   <a href="#" target="_self">Etudes & Assistances</a>
                                               </li>
                                               <li>
                                                   <a href="#" target="_self">Cloud & Sécurité</a>
                                               </li>
                                           </ul>
                                       </li>
